    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Basic Plan */}
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              <div className="p-8">
                <h3 className="text-xl font-bold text-gray-900">Basic</h3>
                <p className="text-gray-500 mt-2 min-h-12">
                  Perfect for individual sales reps.
                </p>
              ...
              <div className="px-8 pb-8 flex-grow">
                ...
                <Button className="w-full py-6 border-2 border-gray-300 bg-white text-gray-800 hover:bg-gray-50">
                  Start Free Trial
                </Button>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-blue-200 ring-2 ring-blue-500/20 overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="p-8">
                  <h3 className="text-xl font-bold text-gray-900">Pro</h3>
                  <p className="text-gray-500 mt-2 min-h-12">
                    Ideal for serious sales professionals.
                  </p>
                ...
                <div className="px-8 pb-8 flex-grow">
                  ...
                  <Button className="w-full py-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white">
                    Start Free Trial
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              <div className="p-8">
                ...
                <p className="text-gray-500 mt-2 min-h-12">
                  For sales teams of up to 5 members.
                </p>
