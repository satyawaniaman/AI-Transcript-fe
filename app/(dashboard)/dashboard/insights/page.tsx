...
const InsightsPage: React.FC = () => {
	...
	const { data: dashboardMetricsData, isLoading: dashboardMetricsLoading } =
	...
	const performanceMetrics = [
		...
		// },
		{
			...
			value: dashboardMetricsLoading
				...
				? `${dashboardMetricsData.talkRatio.average}%`
				: "N/A",
			change: 0, // You would calculate this from historical data
			target: "50:50",
			description: "Sales rep vs prospect talking time",
		...
		},
		{
			...
			value: dashboardMetricsLoading
				? "Loading..."
				: dashboardMetricsData
				? `${dashboardMetricsData.objections.successRate.toFixed(0)}%`
				: "N/A",
			change: 0, // You would calculate this from historical data
			target: "80%",
			description: dashboardMetricsLoading
				? "Loading..."
				: dashboardMetricsData
				? `${dashboardMetricsData.objections.successful} of ${dashboardMetricsData.objections.total} objections handled`
				: "No data available",
