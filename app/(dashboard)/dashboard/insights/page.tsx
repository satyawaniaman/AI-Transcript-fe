  ...
  const keyInsights = [
    {
      ...
      description: "Calls where ROI is discussed in first 5 minutes close 2.3x more often.",
    ...
    },
    {
      ...
      description: "40% of technical objections result in follow-up questions, indicating unclear answers.",
    ...
    },
    {
      ...
      description: "Top performing calls feature 2x more instances of summarizing and reflecting.",
      icon: <Zap className="h-5 w-5" />,
      color: "bg-green-100 text-green-600"
    },
    {
      ...
      description: "35% increase in prospects mentioning competitors over the last month.",
  ...
  const improvementSuggestions = [
    {
      ...
      description: "Prepare detailed answers for the 5 most common technical questions, or consider bringing in a technical resource for complex demos.",
      impact: "high",
    },
    {
      id: 2,
      title: "Create a competitive battlecard",
      description: "Develop standard responses to competitor comparisons, emphasizing your unique differentiators.",
      impact: "medium",
    },
    {
      id: 3,
      title: "Increase open-ended questions",
      description: "Replace yes/no questions with open-ended ones to drive deeper prospect engagement.",
      impact: "high",
    },
    {
      id: 4,
      title: "Improve discovery phase",
      description: "Spend more time understanding prospect needs before presenting solutions.",
      impact: "medium",
    }
  ];
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">AI-powered analysis of your sales performance</p>
          </div>
                    ...
                    <Card>
                      <CardHeader className="flex flex-row items-center justify-between pb-2">
                        <div className="flex items-center">
                          <div className={`mr-3 h-8 w-8 rounded-full ${metric.color} flex items-center justify-center`}>
                            {metric.icon}
                          </div>
              ...
              <motion.div variants={itemVariants}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Track how your call sentiment has evolved across your last 10 calls</CardDescription>
                  </CardHeader>
              ...
              <motion.div variants={itemVariants}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Assessment of your key sales competencies based on call analysis</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between mb-1">
                          <span className="text-sm font-medium">Discovery Skills</span>
                ...
                <motion.div key={insight.id} variants={itemVariants}>
                  <Card>
                    <CardHeader className="flex flex-row items-start gap-4">
                      <div className={`${insight.color} h-10 w-10 rounded-full flex items-center justify-center flex-shrink-0`}>
                        {insight.icon}
                      </div>
                      <div>
              ...
              <motion.div variants={itemVariants} className="md:col-span-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Analysis of your most frequently used words compared to top performers
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="flex flex-col space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium">Words to Use More</span>
                        <span className="text-sm text-gray-500">% of Top Performers Using</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <span className="text-sm font-medium">Words to Use Less</span>
                        <span className="text-sm text-gray-500">% of Lower Performers Using</span>
                      </div>
              ...
              <motion.div variants={itemVariants}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      AI-powered recommendations to enhance your sales effectiveness
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      {improvementSuggestions.map((suggestion) => (
                        <div key={suggestion.id} className="border rounded-lg p-4">
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <h3 className="font-medium text-navy-800">{suggestion.title}</h3>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="border rounded-lg p-4">
                        <h3 className="font-medium text-navy-800">Technical Objection Response Practice</h3>
                        <p className="text-gray-600 mt-2 text-sm">
                          30-minute interactive session to practice responding to technical objections with clear, concise answers.
                        </p>
                      ...
                      <div className="border rounded-lg p-4">
                        <h3 className="font-medium text-navy-800">Value Proposition Framework</h3>
                        <p className="text-gray-600 mt-2 text-sm">
                          Learn a structured approach to articulating value that resonates with different buyer personas.
                        </p>
                        <Button className="mt-4" variant="outline">
                          Start Exercise
                        </Button>
                      ...
                      <div className="border rounded-lg p-4">
                        <h3 className="font-medium text-navy-800">Competitive Differentiation Workshop</h3>
                        <p className="text-gray-600 mt-2 text-sm">
                          Practice responding to competitor comparisons with confidence and without disparaging competitors.
                        </p>
                        <Button className="mt-4" variant="outline">
                          Start Exercise
                        </Button>
