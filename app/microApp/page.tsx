        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                Upload a transcript and get instant AI-powered insights without creating an account.
              </motion.p>
            </div>
            ...
            <motion.div variants={itemVariants}>
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload a transcript or paste text to get a free sample analysis
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Get Full Access</h2>
              <p className="text-gray-600 mb-8">
                Sign up for a free trial to unlock the full power of our AI sales coaching platform.
