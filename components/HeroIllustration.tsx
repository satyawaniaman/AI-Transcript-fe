...
const HeroIllustration = () => {
  return (
    <div className="relative">
      ...
      <div className="absolute -top-6 -right-6 bg-white rounded-lg shadow-lg p-4 w-64 animate-fade-in" style={{ animationDelay: '0.3s' }}>
        <div className="flex justify-between items-center mb-3">
          <div className="bg-navy-100 h-4 w-24 rounded"></div>
          <div className="bg-green-100 text-green-800 text-xs font-medium px-2 py-1 rounded">Positive</div>
        </div>
      ...
      {/* Objection Card */}
      <div className="absolute -bottom-4 -left-8 bg-white rounded-lg shadow-lg p-4 w-56 animate-fade-in" style={{ animationDelay: '0.6s' }}>
        <div className="bg-navy-100 h-4 w-20 rounded mb-3"></div>
        <div className="bg-orange-100 text-orange-800 text-xs font-medium px-2 py-1 rounded inline-block mb-2">Pricing Objection</div>
        <div className="space-y-2">
